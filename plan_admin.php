      ...
      <div class="row">
        <div class="col-md-12">
          <ul class="nav nav-tabs">
            <li class="nav-item">
              <a href="#" class="active nav-link"><i class="glyphicon glyphicon-user"></i>&nbsp;รายการแผนท่องเที่ยว</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="plan_admin.php">สมาชิก</a>
            </li>
            <li class="nav-item">
              <a href="#" class="nav-link">ข้อความ</a>
            </li>
          </ul>
		  <br><br>
    </div>
