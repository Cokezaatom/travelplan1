...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="main.php">แผนการท่องเที่ยว</a>
          </li>
          <li class="nav-item">
 ...
 <center>
	<div class="col-md-4"></div>
		<img class="circle" src="img/User.jpg" height="190px" width="190px"><br><br>
      ...
      <div class="row">
        <div class="col-md-12">
          <ul class="nav nav-tabs">
            <li class="nav-item">
              <a href="planme.php" class="active nav-link">&nbsp;แผนการท่องเที่ยวของฉัน</a>
            </li>
            <li class="nav-item">
              <a class="active nav-link" href="boxme.php">กล่องข้อความ</a>
            </li>
            <li class="nav-item">
              <a class="active nav-link" href="favme.php">แผนการท่องเที่ยวที่ชื่นชอบ</a>
            </li>
          </ul>
        </div>
      </div>
